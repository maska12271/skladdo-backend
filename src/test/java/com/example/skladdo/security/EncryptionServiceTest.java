...
/**
 * Unit tests for the AES-GCM encryption of stored secrets. Pure logic, no Spring context / no database -
 * fast and free of the Testcontainers Postgres startup that JPA-context tests pay for.
 */
