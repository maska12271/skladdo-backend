...
public class PurchaseOrder {
    ...
    /**
     * Stored supplier invoice document for this order. {@code invoiceFileKey} is its S3 object key
     * (resolved to a presigned URL on demand, never stored as a URL); {@code invoiceFileName} is the
     * original filename, used for display and as the download filename. Both null until a file is
     * attached.
     */
